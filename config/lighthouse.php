...
return [
    ...
    */
    ...
    'resolvers' => [
        'Query' => [
            'tasks' => \App\Http\GraphQL\Queries\TaskQueries::class . '@tasks'
        ],
        'Mutation' => [
            'createTask' => \App\Http\GraphQL\Mutations\TaskMutations::class . '@createTask',
            'updateTask' => \App\Http\GraphQL\Mutations\TaskMutations::class . '@updateTask',
            'deleteTask' => \App\Http\GraphQL\Mutations\TaskMutations::class . '@deleteTask',
            'deleteDoneTasks' => \App\Http\GraphQL\Mutations\TaskMutations::class . '@deleteDoneTasks',
        ],
    ],
];
